...
class TranslationTest(unittest.TestCase):
    def test_translation(self):
        ...
        mdc0 = score.MDC.mk_mdc_by_cadence(cadence0, timeflow, 0, False)
        ...
        mdc1 = score.MDC.mk_mdc_by_cadence(cadence1, timeflow, 0, False)
        ...
        cadence2.dur[1] = 0.75
        mdc2A = score.MDC.mk_mdc_by_cadence(cadence2, timeflow, 0, True)
        self.assertEqual(mdc2A[0][0][0], (((p0, p0), p0), (p0, p0), (p0, p0)))
        mdc2B = score.MDC.mk_mdc_by_cadence(cadence2, timeflow, 0, False)
        ...
        cadence3.dur[1] = 0.25
        mdc3A = score.MDC.mk_mdc_by_cadence(cadence3, timeflow, 0, True)
        self.assertEqual(mdc3A[0][0][0], ((p0, (p0, p0)), (p0, p0), (p0, p0)))
        mdc3B = score.MDC.mk_mdc_by_cadence(cadence3, timeflow, 0, False)
        ...
        mdc4 = score.MDC.mk_mdc_by_cadence(cadence4, timeflow, 1, False)
        self.assertEqual(
        ...
        mdc5 = score.MDC.mk_mdc_by_cadence(cadence5, timeflow, 2, False)
        self.assertEqual(
